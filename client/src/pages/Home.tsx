    ...
    <>
      ...
      <section id="network" className="signal-section relative z-10 overflow-hidden border-b border-white/10 bg-[#151a19] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
        ...
        <div className="mx-auto max-w-[1440px]">
          <Reveal className="mb-14 max-w-2xl"><div className="mb-6 flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.25em] text-lime"><span className="h-px w-10 bg-lime" /> The SoloDac network</div><h2 className="font-display text-5xl font-black leading-[0.88] tracking-[-0.08em] sm:text-7xl">Owned attention.<br /><span className="text-white/35">World in focus.</span></h2><p className="mt-7 max-w-xl text-base leading-relaxed text-white/55">A connected network of pages across business, finance, motivation, entrepreneurship, and culture.</p></Reveal>
      ...
      <section className="signal-section relative z-10 bg-paper px-5 py-20 text-ink sm:px-8 lg:px-12 lg:py-28">
        <div className="mx-auto max-w-[1440px]">
          <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
            <Reveal><div className="mb-6 flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.25em] text-ink/45"><span className="h-px w-10 bg-coral" /> Built for modern channels</div><h2 className="max-w-3xl font-display text-5xl font-black leading-[0.88] tracking-[-0.08em] sm:text-8xl">Your audience is already <span className="text-coral">scrolling.</span></h2></Reveal>
