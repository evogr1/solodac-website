    ...
    <main className="min-h-screen overflow-hidden bg-ink text-paper selection:bg-lime selection:text-ink">
      ...
      <header className="relative z-10 border-b border-white/10 bg-ink/90 backdrop-blur-xl">
        <div className="mx-auto flex h-[76px] max-w-[1440px] items-center justify-between px-5 sm:px-8 lg:px-12">
          ...
          <Link href="/#contact" className="flex items-center gap-3 rounded-full border border-lime/60 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.16em] text-lime transition-all hover:bg-lime hover:text-ink">Start a project <ArrowUpRight size={14} /></Link>
        </div>
      </header>
